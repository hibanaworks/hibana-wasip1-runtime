...
pub const TAG_REQ_WASI_FD_PRESTAT_GET: u8 = 26;
pub const TAG_REQ_WASI_FD_PRESTAT_DIR_NAME: u8 = 27;
pub const TAG_REQ_WASI_FD_FILESTAT_GET: u8 = 28;
pub const TAG_REQ_WASI_PATH_FILESTAT_GET: u8 = 29;
...
pub const TAG_RET_WASI_FD_PRESTAT: u8 = 24;
pub const TAG_RET_WASI_FD_PRESTAT_DIR_NAME: u8 = 25;
pub const TAG_RET_WASI_FD_FILESTAT: u8 = 26;
pub const TAG_RET_WASI_PATH_FILESTAT: u8 = 27;
